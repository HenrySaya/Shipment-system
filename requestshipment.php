...
$requestshipment = query("SELECT * FROM addshipment");
// tombol cari ditekan
if (isset($_POST["cari"])) {
    $requestshipment = find($_POST["keyword"]);
}
?>
    ...
    <div class="hero" id="Home">
        ...
        <div class="container mt-5">
            ...
            <form action="" method="post" class="form-cari">
                ...
                <input type="text" name="keyword" size="40" class="mt-4" autofocus placeholder="enter the search keyword.." autocomplete="off" id="keyword">
            ...
            <div id="container">
                <table id="data" class="table table-striped table-responsive text-center mt-4" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php $i = 1; ?>
                        <?php foreach ($requestshipment as $row) : ?>
                            <tr>
                                <td><?= $i; ?></td>
